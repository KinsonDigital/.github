...
<h2 align="center">
  ...
  ![BranchingDiagram](https://github.com/KinsonDigital/.github/blob/master/docs/BranchingDiagram-DarkMode-v1.1.png#gh-dark-mode-only)
  ![BranchingDiagram](https://github.com/KinsonDigital/.github/blob/master/docs/BranchingDiagram-LightMode-v1.1.png#gh-light-mode-only)
</h2>
